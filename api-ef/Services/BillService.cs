...
namespace api_ef.Services
{
    public class BillService : IBillService
    {
        ...
        {
            // 1. Actualiza las propiedades de nivel superior
            ...
            // 2. Actualiza la clave foránea
            if (facturaDto.FormaDePago != null)
            {
                existingFactura.IdForma = facturaDto.FormaDePago.Id;
            }

            // 3. Gestiona los detalles de la factura (la parte más importante)
            if (facturaDto.DetallesFacturas != null)
            {
                // Obtiene los IDs de los detalles que vienen en el DTO
                var detallesDtoIds = facturaDto.DetallesFacturas.Select(d => d.IdDetalle).ToList();

                // a) Elimina los detalles que ya no existen en el DTO
                ...
                // b) Actualiza o agrega los detalles restantes
